...
## Estado de implementación — Free My Chats 2.1.3
...
2.1.3 consume la API 6.0.2 y completa su integración:
...
2.1.3 consume la versión exacta 6.0.2, compatible con la terminología definitiva de
